...
amount_of_password = int(input("Сколько паролей надо?\n"))
len_of_password = int(input("Сколько символов длина пароля?\n"))
Register = input("Включить разный регистр символов (д/н)?\n").upper()
The_precence_of_numbers = input("Включить цифры (д/н)?\n").upper()
The_precence_of_special_characters = input("Включить специмволы (д/н)?\n").upper()
replace_symbols_on_numbers = input("Заменить некоторые буквы на цифры (д/н)?\n").upper()
